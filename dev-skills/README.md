...
ソフトウェア開発向けに構造化された AI ワークフロー集です。10 個の開発者向けプラグインに **66 個のドメイン特化スキル** と **30 個の連携ワークフロー** を収録し、コード品質、アーキテクチャ、テスト、デバッグ、DevOps、スキル管理、プロバイダ統合までカバーします。
...
| [dev-meta](./dev-meta) | 3 | 2 | スキルギャップ分析、調査、スキル自動生成 |
| [dev-integrations](./dev-integrations) | 3 | 1 | AWS Lambda、Terraform、Stripe など外部サービス統合 |
...
| コマンド | 説明 |
|---------|-------------|
| `/skill-gap` | スキルギャップ分析 → 調査 → スキル生成のワークフロー |
| `/new-skill` | 新しいスキルを直接生成 |

### dev-integrations
| コマンド | 説明 |
|---------|-------------|
| `/integration` | 外部サービス統合の設計ワークフロー |
